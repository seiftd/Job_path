...
import { Wand2, Plus, Trash2, Save, Printer, Eye, PenTool, LayoutTemplate, Briefcase, Mail, Phone, GraduationCap, Trophy, Palette, Check, Upload, Image as ImageIcon, Globe } from 'lucide-react';
